            ...
            <Card>
              ...
              <CardContent className="space-y-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  ...
                  >
                    <Sun className={`h-8 w-8 ${theme === "light" ? "text-sky-500" : "text-muted-foreground"}`} />
                    <span className={`text-sm font-medium ${theme === "light" ? "text-sky-600 dark:text-sky-400" : "text-muted-foreground"}`}>
                      Light
                    </span>
                  </button>
                  <button
                  ...
                  >
                    <Moon className={`h-8 w-8 ${theme === "dark" ? "text-sky-500" : "text-muted-foreground"}`} />
                    <span className={`text-sm font-medium ${theme === "dark" ? "text-sky-600 dark:text-sky-400" : "text-muted-foreground"}`}>
                      Dark
                    </span>
                  </button>
                  <button
                  ...
                  >
                    <Monitor className={`h-8 w-8 ${theme === "system" ? "text-sky-500" : "text-muted-foreground"}`} />
                    <span className={`text-sm font-medium ${theme === "system" ? "text-sky-600 dark:text-sky-400" : "text-muted-foreground"}`}>
                      System
                    </span>
                  </button>
                </div>
