        ...
        <section className="relative w-full h-[100vh] overflow-hidden bg-[#e6e8ea]">
            ...
            <div className="absolute inset-0 w-full h-full">
                <video
                    ...
                    muted
                    playsInline
                    src="/rentora-video.webm"
                />
                <div className="absolute inset-0 bg-black/10 pointer-events-none" /> {/* Slight overlay for better text contrast if needed */}
            </div>
                ...
                >
                    ...
                    <div className="bg-white rounded-[2rem] px-10 py-4 text-left shadow-2xl">
                        <h1 className="text-4xl md:text-[2.75rem] font-semibold text-slate-900 tracking-tight mb-4 leading-[1.05]">
                            Your business starts with <span className={`text-sky-500 ${dancingScript.className} text-6xl`}>Rentora</span>
                        </h1>
